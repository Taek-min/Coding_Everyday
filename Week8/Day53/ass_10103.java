...
public class Main{
	public static void main(String[] args){////그냥 이쯤되면 배열애호가네;;; 
		...
		int changYoung[] = new int [round];   // 세미콜론 다 어디갓죠 ? :ㅋㅋㅋㅋㅋ :zzzzzzzz : 억까임 누가 지웟음 누구야 : 너지 누구야
		int sangDeok[] = new int [round];   // 세미콜론 다 어디갓죠 ? : ㅋㅋㅋㅋㅋ :zzzzzzzzzzzz : 억까임 누가 지웟음 누구야 : 너지 누구야
		int sangPoint = 100;
		int changpoint = 100;
