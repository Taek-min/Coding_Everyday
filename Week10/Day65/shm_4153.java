...
public class Main {
	public static void main(String[] args) {
		...
		while(true) {
			//// sides[변들] arraySides[배열변들] 변수 이름이 직관적이지 못한 점이 아쉽습니다
			//// 그냥 곧바로 배열로 만들어버리고 sides로 하거나, 지금 그대로 하고 sideInfos, sides 정도로 이름 붙이는거 추천합니다
			//// 그리고 Arrays.stream(in.nextLine().split(" ")).mapToInt(Integer::parseInt).toArray(); 요렇게 바로 int[]로 만드는 방법도 있습니다. 이건 그냥 참고만 하십셔
			//// ㄴ 그의 피드백이 돌아왔다
